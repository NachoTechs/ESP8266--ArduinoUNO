...
const char* ssid = "NachoCorp."; //ILG
const char* password = "NachoLG1989"; //ILG

const char* host = "script.google.com";
// Replace with your own script id to make server side changes
const char *GScriptId = "AKfycbzwWXoiW7q-2E5nLOU4Q0Wp96wbmXWRFTyVO-T1FKNOHDF0Iudr"; //ILG
